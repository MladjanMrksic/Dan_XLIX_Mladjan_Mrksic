...
Responsibility nvarchar(50) Check (UPPER(Responsibility) = 'Cleaning' or UPPER(Responsibility) = 'Cooking' or UPPER(Responsibility) = 'Overseeing' or UPPER(Responsibility) = 'Reporting') not null,
Paycheck decimal,
WorkExperience int,
